...
namespace Installer
{
    public class ComponentDefinitions
    {
        ...
        public static readonly ComponentDefinition Editor = new ComponentDefinition(InstallationComponent.Editor, "Editor", "Eagle.Editors.exe", "PMD Shift! - Editors", "Pokémon Mystery Dungeon: Shift! Editors");
